...
<div class="fir_display">
  <!-- 左边的模块 -->
  <div class="left">
    <div class="left_nav"><img src="img/char_intro2.png" style="margin:0 5%;width: 40%;"></div>
	...
	<div class="right_content">
		...
		<div style="width: 40%;height: 30px;margin-left: 70%;">
			<form method="get" action="affiche_keyword.php">
				...
				<input type="text" name="keyword" onclick="if(this.value == '请输入关键字查询')this.value='';" value="请输入关键字查询">
		...
		$sql = "select * from affiche where title like '%$keyword%' or long_content like '%$keyword%'";
		// echo $sql;
		...
		$query = "select * from affiche where title like '%$keyword%' or long_content like '%$keyword%' order by id desc limit $offset,$pageSize";
	  ...
	  ?>
		<tr height="90">
			...
			<td width="200" align="center"><?php echo $data['time'] ;?></td>
		</tr>
		<?php
		}      
	  //释放资源 ,关闭数据库
	  ...
	  <div class="sel_page">	
		...
		<a href='affiche_keyword.php?page=1'>首页</a>
		<a href='affiche_keyword.php?page=<?php if($page != 1){echo $page-1;}else{echo $page;} ?>'>上一页</a>
		<a href='affiche_keyword.php?page=1'>1</a>
		<a href='affiche_keyword.php?page=2'>2</a>
		<a href='affiche_keyword.php?page=3'>3</a>
		<a href='affiche_keyword.php?page=4'>4</a>
		<a>...</a>
		<a href='affiche_keyword.php?page=<?php if($page != $page_count){echo $page+1;}else{echo $page;} ?>'>下一页</a>
		<a href='affiche_keyword.php?page=<?php echo $page_count; ?>'>末页</a>
